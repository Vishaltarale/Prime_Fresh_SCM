...
class Farmer(Document):
    ...
    created_by = StringField()  # To track which user created the farmer
...
class Supplier(Document):
    ...
    created_by = StringField()  # To track which user created the supplier
...
class Customer(Document):
    ...
    registration_date = DateField(required=True)
    status = StringField(required=True, choices=['Pending', 'Approve'], default='Pending')
    created_by = StringField()  # To track which user created the customer
