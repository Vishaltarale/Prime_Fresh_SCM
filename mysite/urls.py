...
urlpatterns = [
    ...
    path("adminorderconfirmation/<str:order_id>/",views.adminorderconfirmation,name="adminorderconfirmation"),
    ...
    path('delete_entity/<str:entity>/<str:object_id>', views.delete_entity, name='delete_entity'),
     #ADminApprovePersons
    path('admin_approve_persons/<str:entity>/<str:object_id>', views.admin_approve_persons, name='admin_approve_persons'),      
